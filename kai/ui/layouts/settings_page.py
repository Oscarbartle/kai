...
class SettingsPage(QWidget):
    ...
    def _build(self):
        ...
        # ── Price Display ──
        price_heading = QLabel("Display")
        price_heading.setProperty("role", "heading")
        root.addWidget(price_heading)
        ...
        price_row.addWidget(self.price_mode_combo, 1)
        ...
        t = theme.theme()
        sep0.setStyleSheet(f"background-color: {t.border};")
        root.addWidget(sep0)

        # ── Data Folder ──
        data_heading = QLabel("Data Folder")
        data_heading.setProperty("role", "heading")
        root.addWidget(data_heading)
        ...
        root.addWidget(self.data_dir_status)
        ...
        for group_name, tokens in _GROUPS:
            ...
            group_lbl.setProperty("role", "accent")
