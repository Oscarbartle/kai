...
class CartConfirmDialog(QDialog):
    ...
    def __init__(self, items: list[dict], parent=None):
        ...
        cancel_btn.setStyleSheet(theme.button_css("secondary"))
        cancel_btn.setCursor(Qt.CursorShape.PointingHandCursor)
        cancel_btn.clicked.connect(self.reject)

        add_btn = QPushButton(f"Add {has} Item{'s' if has != 1 else ''} to Cart")
        add_btn.setFixedHeight(36)
        add_btn.setStyleSheet(theme.button_css("primary"))
...
class CartProgressDialog(QDialog):
    ...
    def __init__(self, total: int, parent=None):
        ...
        self._close_btn.setStyleSheet(theme.button_css("secondary"))
        ...
        self._cart_btn.setStyleSheet(theme.button_css("primary"))
